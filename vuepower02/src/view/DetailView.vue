        ...
        <div class="detail-view has-header">
          <div>
            ...
            >
              ...
              <post-detail @hide-toast="toast" v-on:statusNeg="statusNeg" @pop-over="popover"></post-detail>
              <reply-list :page_index_fa="page_index_fa" @hav-more="havMores" @pop-over="popover"></reply-list>
            </van-list>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default {
    name: 'detailView',
    components: {postDetail, replyList, qrCode, logo, noneData},
    data() {
      return {
        showcalendar: false,
        nickname: '',
